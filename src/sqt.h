...
gint sqt_helmholtz_weights_kw_singular(gdouble k,
				       ...
				       gdouble *w,
				       gdouble *work) ;
gint sqt_helmholtz_weights_kw_singular_f(gfloat k, gfloat *ce,
					 gint ne, gint Nk,
					 gfloat *Kq,
					 gint N,
					 gfloat s0,
					 ...
					 gfloat *w,
					 gfloat *work) ;
gint sqt_helmholtz_source_target_tri_adaptive(gdouble k,
					      gdouble *xse,
					      gint xsstr, gint nse,
					      gdouble *q, gint nq,
					      gdouble *Kq,
					      ...
					      gint nt,
					      gdouble *Ast) ;
gint sqt_helmholtz_source_target_tri_adaptive_f(gfloat k,
						gfloat *xse,
						gint xsstr, gint nse,
						gfloat *q, gint nq,
						gfloat *Kq,
						...
						gint nt,
						gfloat *Ast) ;
gint sqt_helmholtz_source_target_kw_adaptive(gdouble k,
					     gdouble *xse,
					     gint sstr, gint nse,
					     gdouble *q, gint nq,
					     gdouble *Ks, gint Ns,
					     ...
					     gint tstr, gint nte,
					     gdouble *Ast, gdouble *work) ;
gint sqt_helmholtz_source_target_kw_adaptive_f(gfloat k,
					       gfloat *xse,
					       gint sstr, gint nse,
					       gfloat *q, gint nq,
					       gfloat *Ks, gint Ns,
					       ...
					       gint tstr, gint nte,
					       gfloat *Ast, gfloat *work) ;
gint sqt_helmholtz_source_target_tri_basic(gdouble k,
					   gdouble *xse,
					   gint xsstr, gint nse,
					   gdouble *q, gint nq,
					   gdouble *Kq,
					   ...
					   gint nt,
					   gdouble *Ast) ;
gint sqt_helmholtz_source_target_tri_basic_f(gfloat k,
					     gfloat *xse,
					     gint xsstr, gint nse,
					     gfloat *q, gint nq,
					     gfloat *Kq,
...
gint sqt_helmholtz_matrix_kw_adaptive_f(gfloat k,
					gfloat *ce, gint ne, gint Nk,
					gfloat *K,
					gfloat *q, gint nq,
					gfloat tol, gint dmax,
					gfloat *x, gint xstr, gint nx,
					gfloat *w, gfloat *work) ;
gint sqt_helmholtz_source_indexed_kw_adaptive(gdouble k,
					      gdouble *xse,
					      gint sstr, gint nse,
					      gdouble *q,
					      gint nq,
					      ...
					      gdouble *Ast,
					      gdouble *work) ;
gint sqt_helmholtz_source_indexed_kw_adaptive_f(gfloat k,
						gfloat *xse,
						gint sstr, gint nse,
						gfloat *q,
						gint nq,
						...
						gfloat *Ast,
						gfloat *work) ;
gint sqt_helmholtz_source_target_kw_self(gdouble k,
					 gdouble *xe,
					 gint xstr, gint ne,
					 gdouble *K,
					 gint nK,
					 ...
					 gdouble *Ast,
					 gdouble *work) ;
gint sqt_helmholtz_source_target_kw_self_f(gfloat k,
					   gfloat *xe,
					   gint xstr, gint ne,
					   gfloat *K,
					   gint nK,
